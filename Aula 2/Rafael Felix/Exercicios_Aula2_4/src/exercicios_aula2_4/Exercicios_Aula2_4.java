...
public class Exercicios_Aula2_4
{
    public static void main(String[] args)
    {
        ...
        {
            System.out.println("Precisa repor o estoque do produto 1!");
        }
        else
        {
            System.out.println("Não precisa repor o estoque do produto 1!");
        }
        
        objEstoque2.precisaRepor();
        if(objEstoque2.precisaRepor() == true)
        {
            System.out.println("Precisa repor o estoque do produto 2!");
        }
        else
        {
            System.out.println("Não precisa repor o estoque do produto 2!");
        }
        
        objEstoque3.precisaRepor();
        if(objEstoque3.precisaRepor() == true)
        {
            System.out.println("Precisa repor o estoque do produto 3!");
        }
        else
        {
            System.out.println("Não precisa repor o estoque do produto3!");
        }
